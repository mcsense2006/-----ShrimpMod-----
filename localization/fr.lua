    ...
    descriptions = {
        Back={
            b_shrimp_DECK_Mahjong = {
                ...
                text = {
                    ...
                    ' ',
                    '{C:attention}Remplace{} toutes les cartes par des cartes {C:Mahjong}Mahjong{}',
                    '{C:red}désactive{} toutes les main non-moddées, vous',
                    'pouvez uniquement jouer des',
                    '{C:attention}mains{}/parties de {C:attention}mains{}gagnantes',
                    'de {C:Mahjong}Riichi Mahjong{}',
                }
            },
        },
        Blind={
            bl_shrimp_BLIND_The_Rune = {
                name = 'La Rune',
                text = {
                    'Toutes les cartes sont debuff sauf si',
                    'un consomable est utilisé ou vendu',
                }
            }
        },
        Edition={},
        ...
        Joker={
            ...
            j_shrimp_JOKER_Sinful_Witch = {
                name = 'La Sorcière pècheuse',
                text = {
                    'Gagne {C:mult}+5{} mult',
                    'pour chaque carte{C:Ultrakill}Peché{}',
                    'utilisée',
                    '{C:inactive}(Actuellement{} {C:mult}+#1#{} {C:inactive}mult)'
                }
            },
            j_shrimp_JOKER_Earthmover = {
                name = 'Earthmover',
                text = {
                    'Crée une carte {C:Ultrakill}Peché{}',
                    'Quand une carte est {C:attention}détruite',
                }
            },
            j_shrimp_JOKER_Brunnhilde = {
                name = 'Brünnhilde',
                text = {
                    'Déclenche à nouveau la {C:attention}derniere{} carte',
                    'jouer pour marquer des points',
                    '{C:attention}2{} fois supplémentaires'
                }
            },
            ...
            j_shrimp_JOKER_The_Library_Of_Order = {
                ...
                text = {
                    ...
                    '2 joker {C:legendary,E:1}Légendaires{} aléatoire',
                    'La {C:green}probabilitée{} {C:attention}est doublée',
                    'à chaque fois ue le round se termine',
            ...
            j_shrimp_JOKER_Steam_Joker = {
                ...
                text = {
                    ...
                    'au minimum 1 {C:spades}pique{} scorée',
            ...
            j_shrimp_JOKER_Drunk_Vision = {
                ...
                text = {
                    ...
                    '{C:mult}WILL EITHER NOT WORK AS INTENDED OR CRASH YOUR GAME{}',
                    ' ',
                    '{C:attention}9s{} becomes {C:attention}6s{}',
                    'and {C:attention}As{} becomes {C:attention}2s{}',
                    ' ',
