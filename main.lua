...
function G.FUNCS.joy_youtube(e)
    love.system.openURL("https://youtube.com/")
end
                            ...
                            nodes = {
                                {
                                    n = G.UIT.T,
                                    config = {
                                        text = "Artists: The Shrimp, theCater_",
                                        shadow = false,
                                        scale = scale,
                                        colour = G.C.MONEY
                                    }
                            ...
                            nodes = {
                                {
                                    n = G.UIT.T,
                                    config = {
                                        text = "Concepting: Credit for each additions are put on them, planet cards by u/Cuddly_Corvid",
                                        shadow = false,
                                        scale = scale * 0.6,
                                        colour = G.C.BLACK
                                    }
